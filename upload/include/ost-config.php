...
define('SECRET_SALT','Xw0oVHNmt94hON6McDNyGVpwPh00q5k8');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','juniorjmenezes@gmail.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','mysql05-farm76.kinghost.net');
define('DBNAME','cruz01');
define('DBUSER','cruz01');
define('DBPASS','Cubldsv2017');
