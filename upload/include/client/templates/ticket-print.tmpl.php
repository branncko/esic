...
<htmlpagefooter name="def" style="display:none">
    ...
    <table width="100%" style="font-family: 'Arial';">
		<tr>
			<td class="flush-left">
				<?php echo __('Request #'); ?><?php echo $ticket->getNumber(); ?> - 
				<?php echo __('&nbsp;Printed on&nbsp;'); ?><?php echo Format::daydatetime(Misc::gmtime()); ?>
			</td>
		</tr>
		<tr>
			<td class="flush-left">
			Gerado pelo E-SIC - Sistema de Informações ao Cidadão da Prefeitura de Cruz/CE
			</td>
...
<!-- Ticket metadata -->
<h1 style="font-family: Arial"><?php echo __('Request #'); ?><?php echo $ticket->getNumber(); ?></h1>
<table style="font-family: Arial; font-size: 13px" class="meta-data" cellpadding="0" cellspacing="0">
<tbody>
<tr>
...
<tr>
    ...
    <td><?php echo $thisclient->getCPF(); ?></td>
</tr>
<tr>
...
foreach (DynamicFormEntry::forTicket($ticket->getId()) as $form) {
    ...
    if (count($answers) == 0)
        continue;
    ?>
        <table style="font-family: Arial; font-size: 12px" class="custom-data" cellspacing="0" cellpadding="0" width="100%" border="0">
			<tr>
...
<!-- Ticket Thread -->
<h2 style="font-family: Arial"><?php echo $ticket->getSubject(); ?></h2>
...
if ($thread = $ticket->getThreadEntries($types)) {
    ...
    foreach ($thread as $entry) { ?>
        <div style="margin-bottom: 10px" class="thread-entry <?php echo $threadTypes[$entry->type]; ?>">
            <table style="font-family: Arial; font-size: 12px" class="header">
				<tr>
					<td>
						<span><?php echo Format::datetime($entry->created);?></span>
						<span style="padding:0 1em" class="faded title"><?php echo Format::truncate($entry->title, 100); ?></span>
					</td>
					<td class="flush-right faded title" style="white-space:no-wrap">
						<span style="color: #2a2a2a"><?php echo Format::htmlchars($entry->getName()); ?></span>
					</td>
				</tr>
			</table>
            ...
            if ($entry->has_attachments
                ...
                <div style="font-family: Arial" class="info">
