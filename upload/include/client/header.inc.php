...
$title=($cfg && is_object($cfg) && $cfg->getTitle())
    ? $cfg->getTitle() : 'E-SIC :: '.__('Sistema Eletrônico de Informações ao Cidadão');
...
<head>
    ...
    <meta name="description" content="Sistema Eletrônico de Informações ao Cidadão">
    <meta name="keywords" content="E-SIC, Sistema, Eletrônico, Informações, Cidadão, Transparência, Acesso a Informação">
    ...
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/modifica.css" media="screen"/>
	<link href="https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i,700,700i&display=swap" rel="stylesheet">
	<link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/reset.css">
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>bootstrap/css/bootstrap-grid.css" media="screen"/>
    ...
    <link type="text/css" href="<?php echo ROOT_PATH; ?>css/ui-lightness/jquery-ui-1.10.3.custom.min.css?a076918" rel="stylesheet" media="screen" />
    ...
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/uppercase.js"></script>
...
<body>
    <div id="container">
        <div id="header">
            <div class="pull-right flush-right white">
			<p class="text-legal"><?php echo __('Acesso à Informação - LEI nº 12.527/2011'); ?></p>
            <p>
             <?php
                ...
                <a href="<?php echo ROOT_PATH; ?>tickets.php"><?php echo sprintf(__('Requests <b>(%d)</b>'), $thisclient->getNumTickets()); ?></a> -
...
<?php }
        ...
        <ul id="nav" class="flush-left">
			...
			<li><a style="font-weight: 300" class="perguntas" href="https://www.cruz.ce.gov.br/transparencia-municipal/perguntas-frequentes/" target="_blank">Perguntas Frequentes</a></li>
			<li><a style="font-weight: 300" class="transparencia-municipal" href="https://www.cruz.ce.gov.br/transparencia-municipal" target="_blank">Transparência Municipal</a></li>
			<li><a style="font-weight: 300" class="ouvidoria" href="https://www.cruz.ce.gov.br/transparencia-municipal/ouvidoria/" target="_blank">Ouvidoria</a></li>
        </ul>
        <?php
        }else{ ?>
         <hr>
