...
<div id="view-new">
	<table width="100%" cellpadding="1" cellspacing="0" border="0" id="ticketInfo">
		<tr>
			<td colspan="2" width="100%">
				<h1>
					<a href="tickets.php?id=<?php echo $ticket->getId(); ?>" title="<?php echo __('Reload'); ?>"></a>
			...
			<td width="50%">
				<table class="infoTable" cellspacing="1" cellpadding="3" width="100%" border="0">
					<thead>
						<tr>
							<td class="headline" colspan="2">
								<?php echo __('Basic Request Information'); ?>
							</td>
						</tr>
					</thead>
					<tr>
					...
					<tr>
						...
						<td><?php echo Format::htmlchars($dept instanceof Dept ? $ticket->getSubject() : ''); ?></td>
					</tr>
					<tr>
	...
	<form id="reply" action="tickets.php?id=<?php echo $ticket->getId();
		...
		<div>
			<p><em><?php
				echo __('Please enter a short and straightforward answer so we can help you more quickly.'); ?></em>
