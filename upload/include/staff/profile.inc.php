...
<h2><?php echo __('My Account Profile');?></h2>
  ...
  <div class="tab_content" id="account">
    <table class="table two-column" width="940" border="0" cellspacing="0" cellpadding="2">
      <tbody>
        <tr><td colspan="2"><div>
        <div class="avatar pull-left" style="margin: 0 20px 0 0; width: 100px; height: 100px;">
...
<?php
        ...
        <table class="table two-column" border="0" cellspacing="2" cellpadding="2" style="width:100%; margin-bottom:20px">
        <tr>
      ...
      <tbody>
        ...
        <tr>
            <td width="180"><?php echo __('Auto Refresh Rate');?>:
              <div class="faded"><?php echo __('Request page refresh rate in minutes.'); ?></div>
            </td>
            <td>
        ...
        <tr>
            <td>
                <?php echo __('Default Request Queue'); ?>:
            </td>
            <td>
        ...
        <tr>
            <td width="180"><?php echo __('Default Paper Size');?>:
              <div class="faded"><?php echo __('Paper size used when printing Requests to PDF');?></div>
            </td>
            <td>
        ...
        <tr>
            <td><?php echo __('Reply Redirect'); ?>:
                <div class="faded"><?php echo __('Redirect URL used after replying to a Request');?></div>
            </td>
            <td>
                <select name="reply_redirect">
                  <?php
                  $options=array('Queue'=>__('Queue'),'Ticket'=>__('Request'));
...
<?php } ?>
  ...
  <div id="signature" class="hidden">
    <table class="table two-column" width="100%">
      <tbody>
        <tr class="header signature">
          <th colspan="2">
            <?php echo __('Signature'); ?>
            <div><small><?php echo __(
            "Optional signature used on outgoing emails.")
            .' '.
            __('Signature is made available as a choice, on Request reply.'); ?>
            </small></div>
          </th>
        </tr>
        <tr>
