...
<div class="pull-left" style="margin-top:5px;">
   <?php
    if ($total) {
        ...
        echo sprintf(__('%s does not have any Requests'), $user? __('User') : __('Organization'));
    }
   ?>
</div>
    ...
    <div class="pull-right flush-right">
        ...
        if ($user) { ?>
            <a class="green button action-button" href="tickets.php?a=open&uid=<?php echo $user->getId(); ?>">
                <i class="icon-plus"></i> <?php print __('Create New Request'); ?></a>
        <?php
        } ?>
    </div>
</div>
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="2" width="100%">
    <thead>
        <tr>
            ...
            <th width="10%"><?php echo __('Request'); ?></th>
        ...
        <tr id="<?php echo $T['ticket_id']; ?>">
            ...
            <td nowrap>
              <a class="Icon <?php
                ...
                title="<?php echo __('Preview Request'); ?>"
