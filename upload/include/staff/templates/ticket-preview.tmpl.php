...
echo '
        <li class="active"><a id="preview_tab" href="#preview"
            ><i class="icon-list-alt"></i>&nbsp;'.__('Request Summary').'</a></li>';
...
echo sprintf('
        <tr>
            <th width="100">'.__('Request State').':</th>
            <td>%s</td>
        </tr>
        <tr>
            <th>'.__('Created').':</th>
...
<div class="hidden tab_content" id="collab">
    <table border="0" cellspacing="" cellpadding="1">
        ...
        <?php
            ...
            echo __("Request doesn't have any collaborators.");
        }?>
    </table>
    <br>
    <?php
...
if ($role->hasPerm(Ticket::PERM_EDIT))
    $options[]=array('action'=>__('Edit Request'),'url'=>"tickets.php?id=$tid&a=edit");
