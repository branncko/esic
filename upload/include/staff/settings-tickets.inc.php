...
?>
<h2><?php echo __('Request Settings and Options');?></h2>
...
<table class="form_table settings_table" width="940" border="0" cellspacing="0" cellpadding="2">
    <thead>
        <tr>
            <th colspan="2">
                <em><?php echo __('System-wide default request settings and options.'); ?></em>
            </th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td>
                <?php echo __('Default Request Number Format'); ?>:
            </td>
            <td>
        ...
        <tr><td width="220"><?php echo __('Default Request Number Sequence'); ?>:</td>
...
<?php } ?>
        ...
        <tr><td width="220"><?php echo __('Top-Level Request Counts'); ?>:</td>
            <td>
        ...
        <tr>
            <td width="180"><?php echo __('Default Request Type'); ?>:</td>
            <td>
...
<?php } ?>
        ...
        <tr>
            <td><?php echo __('Maximum <b>Open</b> Requests');?>:</td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <?php echo __('Enable CAPTCHA on new Requests.');?>
